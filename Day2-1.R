#import a file from excel or google sheet
library(rJava)
library(xlsx)
...
read1
read1 = read.csv(file="./data/.csv", header = TRUE,sep = ",")
#csv file can have only one sheet while excel can have any
...
head(df_gsheet)
url2="https://docs.google.com/spreadsheets/d/1yJEyHSRenbflgLdO1mZ9c-2LBM9v0xY7E7szMMX1QYM/edit#gid=0"

...
#Rpart.control is basically to restrict the decision tree parameter
**minsplit**	
...
```{r}
#Na.action= na.omit is used to indicate that we should ignore the values which are not there
